  ...
  return (
    <div className='relative z-10'>
      ...
      <div className='text-white'>
        ...
        <div className='text-white/80 text-lg tracking-widest mt-10'>
          <p>Hi there 🖐🏻</p>

          <p className='flex items-center gap-x-3 mt-2'>
            <span>I'm</span>
            <span className='text-sky-400 text-base font-bold px-4 py-1.5 border-2 border-sky-400 rounded-2xl shadow-xl'>
              Matin Hedayat
            </span>
          </p>
        </div>
