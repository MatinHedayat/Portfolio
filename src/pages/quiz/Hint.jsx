        ...
        <div className='text-gray-800 dark:text-gray-200 max-h-[65%] pb-8 pr-4 overflow-auto'>
          ...
          <div className='font-medium flex flex-col gap-y-6'>
            ...
            <div>
              ...
              <p>
                after setting the settings you can start the game by pressing
                the <b>Start Game</b> button. On the questions page, you can
                choose the answer to each question or leave the question
                unanswered and press the <b>Next</b> button to go to the next
                question. After completing the questions, you can see the result
                of your performance on the result page
              </p>
            </div>
          </div>
        </div>
